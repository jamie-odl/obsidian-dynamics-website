...
async function apiCheck() {
  ...
  process.env.ADMIN_ALLOWLIST = process.env.ADMIN_ALLOWLIST || 'contact@obsidiandynamics.co.uk';
  ...
  const reqAllow = { method: 'POST', body: { email: 'contact@obsidiandynamics.co.uk', next: 'developer-central.html' }, headers: { host: 'localhost:3000', 'x-forwarded-proto': 'http' }, socket: { remoteAddress: '127.0.0.1' } };
