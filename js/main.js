...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function applyGlobalBrandShell() {
        ...
        const footerMarkup =
            ...
            '    <p class="footer-tagline">Air-domain intelligence (SkyGrid) and security governance (Blackglass).</p>' +
    ...
    function ensureSeoMetaDefaults() {
        ...
        const description = ((descTag && descTag.getAttribute('content')) || '').trim()
            || 'Obsidian Dynamics: Project SkyGrid for air-domain intelligence; Blackglass for security posture and governance.';
